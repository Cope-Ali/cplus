 ...
 ***********************************************/
void Messages::display(Control control) const
{
   for (list <Message> :: const_iterator it = messages.begin();
        it != messages.end();
        ++it)
      it->displayProperties(control);
}
 ...
 **********************************************/
void Messages::show(int id, Control control) const
{
   for (list <Message> :: const_iterator it = messages.begin();
        it != messages.end();
        ++it)
      if (it->getID() == id)
         it->displayText(control);
}
 ...
 ***********************************************/
void Messages::update(int id, const string & text, Control control)
{
   for (list <Message> :: iterator it = messages.begin();
        it != messages.end();
        ++it)
      if (it->getID() == id)
         it->updateText(text, control);
}
 ...
 **********************************************/
void Messages::remove(int id, Control control)
{
   for (list <Message> :: iterator it = messages.begin();
        it != messages.end();
        ++it)
