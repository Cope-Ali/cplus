...
*    Ali Cope
* Summary: 
*    Program is designed to calculate the number of days that have passed
*    since Jan 1 1753 to month and year provided by user. Program will
*    then output the calander for the requested month and year with the
*    correct offset (start of the week).
*
*    Estimated:  2.0 hrs   
*    Actual:     6.0 hrs
*      This program went much smoother than it could have because I took
*    the time to create and test each function one at a time. This allowed
*    me to know right where the problems were so that I could correct them
*    as I went, instead of having a huge mess at the end. I also did several
*    revisions where I combined functions that were too modularized and
*    found more efficient loops to create the calendar.
*
*
************************************************************************/
...
/**********************************************************************
* calculates how many days have passed since Jan 1 1753. First counts
...
/******************************************************
* calculates offset by parsing the number odays by 7
*****************************************************/
int computeOffset (int numDays)
{
...
/*****************************************************
* calculate number of days in desired month
***************************************************/
int computeMonthLength (int month, int isLeap)
{
   int days = 0;
