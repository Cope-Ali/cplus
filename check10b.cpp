...
void promptInventory(vector<Food *> &items)
{
    ...
    do
    {
        ...
        if (name != "quit")
        {
            ...
            //Food newItem(name, month, year);
            Food *newItem = new Food(name, month, year);
            // Food * pItem = &newItem;
            // cout << pItem;
 ...
 *  deletes them.
 *****************************************************/
void removeExpiredItems(vector<Food *> &items, int currentMonth, int currentYear)
{
    // TODO: Fill this in!
    // Use an iterator to walk through the vector
