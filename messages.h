...
public:
   ...
   void display(Control control) const;

   // show a single message
   void show(int id, Control control) const;

   // update one single message
   void update(int id,
               const std::string & text, Control control);

   // remove a single message
   void remove(int id, Control control);

   // add a new message
   void add(const std::string & text,
            const std::string & author,
            const std::string & date, Control control);
